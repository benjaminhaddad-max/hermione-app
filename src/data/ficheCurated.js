...
const FICHE_CURATED = {
  "Structure et diversité du génome": {
    images: [
      "acides-nucleiques-et-structure-des-genomes-illus-02.webp",  // Organisation hiérarchique du génome
      "acides-nucleiques-et-structure-des-genomes-illus-31.webp",  // Caryotype humain 46 chromosomes
      "acides-nucleiques-et-structure-des-genomes-illus-30.webp",  // Organisation chromatine eucaryote
    ],
...
Vocabulaire clé : locus (position sur un chromosome), allèles (variantes d'un gène), nucléosome (ADN + histones), transposons (éléments mobiles du génome).`
  ...
  "Structure des acides nucléiques": {
    images: [
      "acides-nucleiques-et-structure-des-genomes-illus-01.webp",  // Double hélice ADN 3D
      "acides-nucleiques-et-structure-des-genomes-illus-21.webp",  // Comparaison ADN vs ARN
      "acides-nucleiques-et-structure-des-genomes-illus-23.webp",  // Organisation du chromosome à la double hélice
    ],
...
L'ARN existe sous plusieurs formes : ARNm (messager, copie d'un gène), ARNt (transfert, apporte les acides aminés), ARNr (ribosomal, structure du ribosome). Chacun a un rôle précis dans la fabrication des protéines.`
  ...
  "La réplication de l'ADN": {
    images: [
      "replication-illus-15.webp",   // Fourche de réplication
      "replication-illus-04.webp",   // Mécanisme de réplication
      "replication-illus-18.webp",   // Raccourcissement des télomères
    ],
...
Exception : la télomérase (active dans les cellules souches et les cellules cancéreuses) peut rallonger les télomères.`
  ...
  "La transcription": {
    images: [
      "transcription-et-traduction-illus-06.webp",  // Synthèse ARN à partir ADN
      "transcription-et-traduction-illus-03.webp",  // Structure gène eucaryote
      "regulation-expression-des-genes-p1-illus-01.webp",  // Dogme central
    ],
...
La transcription (ADN→ARN) a lieu dans le noyau. L'ARNm mature sort ensuite par les pores nucléaires pour être traduit dans le cytoplasme. La régulation de la transcription est le principal moyen pour la cellule de contrôler quelles protéines elle fabrique.`
  ...
  "La traduction": {
    images: [
      "transcription-et-traduction-illus-19.webp",  // Code génétique
      "transcription-et-traduction-illus-26.webp",  // Cycle élongation traduction
      "transcription-et-traduction-illus-20.webp",  // ARNt 3D
    ],
...
Plusieurs ribosomes peuvent traduire le même ARNm simultanément (polyribosome), ce qui permet de produire beaucoup de copies de la même protéine très rapidement.`
  ...
  "Les protéines": {
    images: [
      "structures-secondaires-illus-03.webp",  // 4 niveaux de structure
      "repliement-des-proteines-illus-14.webp",  // Entonnoir repliement
      "structures-tertiaires-et-quaternaires-illus-55.webp",  // Anticorps
    ],
...
Si la forme change (dénaturation par la chaleur, le pH, etc.), la protéine perd sa fonction. C'est pour ça qu'un œuf cuit ne peut pas redevenir cru : les protéines ont perdu leur forme originale de façon irréversible.`
  ...
  "Métabolisme énergétique": {
    images: [
      "base-de-cinetique-enzymatique-illus-08.webp",  // Profil énergétique avec/sans catalyseur
      "base-de-cinetique-enzymatique-illus-09.webp",  // Cycle ATP/ADP
      "cinetique-enzymatique-illus-02.webp",  // Courbe Michaelis-Menten
    ],
...
C'est grâce à cette régulation fine que la cellule adapte son métabolisme en temps réel.`
  ...
  "Les glucides": {
    images: [
      "glucides-et-lipides-illus-02.webp",   // Classification des glucides
      "glucides-et-lipides-illus-08.webp",   // Cyclisation du glucose
      "glucides-et-lipides-illus-19.webp",   // Structure du glycogène
    ],
...
• Les glycoprotéines (protéines + sucres) jouent un rôle clé dans la reconnaissance cellulaire`
  ...
  "Les lipides": {
    images: [
      "glucides-et-lipides-illus-27.webp",  // Classification des lipides
      "glucides-et-lipides-illus-33.webp",  // Membrane cellulaire
      "glucides-et-lipides-illus-31.webp",  // Cholestérol
    ],
...
Le corps utilise d'abord le glucose, puis puise dans les réserves de glycogène, et enfin mobilise les graisses pour les efforts prolongés.`
  ...
  "Introduction à la biochimie": {
    images: [
      "base-de-cinetique-enzymatique-illus-10.webp",  // Carte métabolique
      "structures-secondaires-illus-03.webp",           // 4 niveaux structure protéique
      "base-de-cinetique-enzymatique-illus-02.webp",   // Enzyme 3D
    ],
